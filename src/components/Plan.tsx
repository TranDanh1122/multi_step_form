...
const Plan = React.memo(({ selected, image,
    ...
    monthvalue,
    yearvalue,
    duration }: PlanProps): React.JSX.Element => {
    return (
        <div className={clsx('rounded-lg w-full px-4 py-5 border-[1px] border-solid', {
            ...
            <span className='m text-[var(--cool-gray)] block'>{monthvalue}</span>
